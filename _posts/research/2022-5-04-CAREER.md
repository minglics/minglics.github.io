...
**GlassScope: An Open-Source Measurement Layer for AI-Glass Live Streaming,**\
Raoa Faria Karim, John Cobio, Bai Songling, Wei Li, Yingshu Li, and Ming Li,\
ACM Workshop on Mobile Immersive Computing, Networking, and Systems (ImmerCom'26, co-located with MobiCom'26), 2026.
{: .research.desc}

**[OptiVibe: Keystroke Inference Attacks Through A New Optical-Vibration Side Channel,](/publications/OptiVibe.pdf)**\
Youngtak Cho, Sanket Suresh Badgujar, Srinivasan Murali, Xuhao Xie, and Ming Li,\
IEEE International Conference on Distributed Computing Systems (ICDCS), 2026.
{: .research.desc}

**[Bere: A Novel Video Recommender System for Virtual Reality Using Human Behavioral Signals,](/publications/bere.pdf)**\
Huadi Zhu, Chaowei Wang, Venkateshwar Reddy Darmanola, Hongbo Guo, Wenqiang Jin, and Ming Li,\
ACM Conference on Mobile Computing and Networking (MobiCom), 2024.
{: .research.desc}

**[Avara: A Uniform Evaluation System for Perceptibility Analysis Against Adversarial Object Evasion Attacks,](/publications/avara.pdf)**\
Xinyao Ma<span>*</span>, Chaoqi Zhang<span>*</span>, Huadi Zhu<span>*</span>, Jean Camp, Ming Li, and Xiaojing Liao (<span>*</span>equal contribution),\
